...
--
What does git clone do;What does git fork do;Different between git clone and git fork.
Git clone downloads a copy of a remote repository to your local machine, allowing you to work on the code offline; the cloned repo remains linked to the original so you can push changes back if you have permission.
